...
public class e<K, V> {
    ...
    public final V b(K r5) {
        /*
            ...
            int r5 = r4.f1647g     // Catch:{ all -> 0x0051 }
            int r5 = r5 + 1
            r4.f1647g = r5     // Catch:{ all -> 0x0051 }
            monitor-exit(r4)     // Catch:{ all -> 0x0051 }
            return r0
        L_0x0013:
            int r0 = r4.f1648h     // Catch:{ all -> 0x0051 }
            int r0 = r0 + 1
            r4.f1648h = r0     // Catch:{ all -> 0x0051 }
            monitor-exit(r4)     // Catch:{ all -> 0x0051 }
        ...
        L_0x0054:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: g.a.e.b(java.lang.Object):java.lang.Object");
    }

    public final synchronized String toString() {
        int i2;
        i2 = this.f1647g + this.f1648h;
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.c), Integer.valueOf(this.f1647g), Integer.valueOf(this.f1648h), Integer.valueOf(i2 != 0 ? (this.f1647g * 100) / i2 : 0)});
    }
    ...
    public void a(int r5) {
        ...
        L_0x001e:
            ...
            int r2 = r4.f1646f     // Catch:{ all -> 0x0071 }
            r3 = 1
            int r2 = r2 + r3
            r4.f1646f = r2     // Catch:{ all -> 0x0071 }
        ...
        L_0x0075:
            goto L_0x0074
        */
        throw new UnsupportedOperationException("Method not decompiled: g.a.e.a(int):void");
    }
}
