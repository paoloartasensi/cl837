...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        private class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((h) message.obj);
                }
            }
        }
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(h hVar) {
            long j2;
            if (this.mMediaPlayPauseKeyPending) {
                ...
                if (mediaSessionImpl != null) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo(hVar);
                    if (z2 && z) {
                        onPause();
                    } else if (!z2 && z3) {
                        onPlay();
                    }
                    mediaSessionImpl.setCurrentControllerInfo((h) null);
                }
            }
        }
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            h currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(h hVar);
        ...
        void setPlaybackToRemote(l lVar);
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final h getCurrentControllerInfo() {
            return new h(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }

        public void setCurrentControllerInfo(h hVar) {
        }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private l.a mVolumeCallback = new l.a() {
            public void onVolumeChanged(l lVar) {
                if (MediaSessionImplBase.this.mVolumeProvider == lVar) {
                    MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                    MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, lVar.c(), lVar.b(), lVar.a()));
                }
            }
        };
        l mVolumeProvider;
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    l lVar = MediaSessionImplBase.this.mVolumeProvider;
                    if (i2 == 2) {
                        int c = lVar.c();
                        int b = lVar.b();
                        i4 = lVar.a();
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new h("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (callback != null) {
                    ...
                    MediaSessionImplBase.this.setCurrentControllerInfo(new h(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
                    ...
                    try {
                        ...
                        MediaSessionImplBase.this.setCurrentControllerInfo((h) null);
                    }
                }
            }
        }
        ...
        public h getCurrentControllerInfo() {
            h hVar;
            synchronized (this.mLock) {
                hVar = this.mRemoteUserInfo;
            }
            return hVar;
        }
        ...
        public void setPlaybackToRemote(l lVar) {
            if (lVar != null) {
                l lVar2 = this.mVolumeProvider;
                if (lVar2 != null) {
                    lVar2.a((l.a) null);
                }
                this.mVolumeType = 2;
                this.mVolumeProvider = lVar;
    ...
    static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat playbackStateCompat, MediaMetadataCompat mediaMetadataCompat) {
        ...
        return new PlaybackStateCompat.Builder(playbackStateCompat).setState(playbackStateCompat.getState(), (j2 < 0 || playbackSpeed <= j2) ? playbackSpeed < 0 ? 0 : playbackSpeed : j2, playbackStateCompat.getPlaybackSpeed(), elapsedRealtime).build();
    }
    ...
    public void setPlaybackToRemote(l lVar) {
        if (lVar != null) {
            this.mImpl.setPlaybackToRemote(lVar);
            return;
        }
        throw new IllegalArgumentException("volumeProvider may not be null!");
    }
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                if (!mediaSessionImplApi21.mDestroyed) {
                    ...
                    MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new h(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        public void setPlaybackToRemote(l lVar) {
            MediaSessionCompatApi21.setPlaybackToRemote(this.mSessionObj, lVar.d());
        }
