...
public final class b {
    ...
    static {
        ...
        if (a2 >= 65544) {
            try {
                newInstance2 = Class.forName("kotlin.n.e.a").newInstance();
                i.a((Object) newInstance2, "Class.forName(\"kotlin.in…entations\").newInstance()");
                ...
                try {
                    ...
                    i.a((Object) newInstance3, "Class.forName(\"kotlin.in…entations\").newInstance()");
        ...
        if (a2 >= 65543) {
            try {
                newInstance = Class.forName("kotlin.n.d.a").newInstance();
    ...
    private static final int a() {
        ...
        int a2 = m.a((CharSequence) property, '.', 0, false, 6, (Object) null);
        if (a2 < 0) {
            try {
            ...
            int i2 = a2 + 1;
            int a3 = m.a((CharSequence) property, '.', i2, false, 4, (Object) null);
            if (a3 < 0) {
                a3 = property.length();
            }
            if (property != null) {
