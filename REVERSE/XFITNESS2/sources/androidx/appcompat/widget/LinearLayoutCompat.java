...
public class LinearLayoutCompat extends ViewGroup {
        ...
        for (int i6 = 0; i6 < virtualChildCount; i6++) {
            ...
            if (!(a3 == null || a3.getVisibility() == 8 || !b(i6))) {
                ...
                if (a2) {
                    ...
                    i5 = (a3.getLeft() - aVar.leftMargin) - this.p;
                }
                b(canvas, i5);
            }
        }
    ...
    public void b(Canvas canvas) {
        ...
        for (int i3 = 0; i3 < virtualChildCount; i3++) {
            ...
            if (!(a2 == null || a2.getVisibility() == 8 || !b(i3))) {
                a(canvas, (a2.getTop() - ((a) a2.getLayoutParams()).topMargin) - this.q);
            }
        }
        if (b(virtualChildCount)) {
            View a3 = a(virtualChildCount - 1);
            if (a3 == null) {
                i2 = (getHeight() - getPaddingBottom()) - this.q;
            } else {
    ...
    public int getBaseline() {
        ...
        if (childCount > i3) {
            ...
            if (baseline != -1) {
                int i4 = this.f234g;
                if (this.f235h == 1 && (i2 = this.f236i & 112) != 48) {
                    if (i2 == 16) {
                        i4 += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f237j) / 2;
                    } else if (i2 == 80) {
                        i4 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f237j;
                    }
                }
                return i4 + ((a) childAt.getLayoutParams()).topMargin + baseline;
            } else if (this.f233f == 0) {
                return -1;
            } else {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.k = a2.b(R$styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.f233f = a2.d(R$styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.l = a2.a(R$styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a2.b(R$styleable.LinearLayoutCompat_divider));
        this.r = a2.d(R$styleable.LinearLayoutCompat_showDividers, 0);
        this.s = a2.c(R$styleable.LinearLayoutCompat_dividerPadding, 0);
        a2.a();
    }
    ...
    public void a(int r38, int r39) {
        ...
        L_0x0305:
            ...
            android.view.View r2 = r7.a((int) r10)
        ...
        L_0x035e:
            ...
            android.view.View r14 = r7.a((int) r10)
    ...
    public void b(int r34, int r35) {
        ...
        L_0x0285:
            ...
            android.view.View r13 = r7.a((int) r8)
    ...
    public void b(int r18, int r19, int r20, int r21) {
        ...
        L_0x0049:
            ...
            android.view.View r13 = r6.a((int) r12)
            r14 = 1
        ...
        L_0x0059:
            ...
            r1 = r11
        L_0x0075:
            int r2 = androidx.core.h.v.o(r17)
            int r1 = androidx.core.h.d.a(r1, r2)
            r1 = r1 & 7
    ...
    public void a(int r25, int r26, int r27, int r28) {
        /*
            r24 = this;
            r6 = r24
            boolean r0 = androidx.appcompat.widget.m0.a(r24)
            ...
            int[] r13 = r6.m
            int[] r14 = r6.n
            int r1 = androidx.core.h.v.o(r24)
            int r1 = androidx.core.h.d.a(r2, r1)
            r15 = 2
            r5 = 1
