...
public class AppCompatViewInflater {
    ...
    private static final Map<String, Constructor<? extends View>> sConstructorMap = new g.a.a();
    ...
    private static class a implements View.OnClickListener {
        ...
        private void a(Context context, String str) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.f58f, new Class[]{View.class})) != null) {
                        this.f59g = method;
                        this.f60h = context;
                        return;
                    }
            ...
            throw new IllegalStateException("Could not find method " + this.f58f + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.e.getClass() + str2);
        }

        public void onClick(View view) {
            if (this.f59g == null) {
                a(this.e.getContext(), this.f58f);
            }
            try {
                this.f59g.invoke(this.f60h, new Object[]{view});
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (Build.VERSION.SDK_INT < 15 || v.y(view)) {
