...
public final class a {
    ...
    public static void d(Context context) {
        ...
        if (b) {
            ...
            try {
                ...
                a(context, new File(b2.sourceDir), new File(b2.dataDir), "secondary-dexes", BuildConfig.FLAVOR, true);
    ...
    private static void a(android.content.Context r5, java.io.File r6, java.io.File r7, java.lang.String r8, java.lang.String r9, boolean r10) {
        /*
            ...
            monitor-enter(r0)
            java.util.Set<java.io.File> r1 = a     // Catch:{ all -> 0x009e }
        ...
        L_0x0055:
            ...
            return
        L_0x005d:
            a((android.content.Context) r5)     // Catch:{ all -> 0x0061 }
            goto L_0x0069
        L_0x0061:
            r2 = move-exception
    ...
    private static final class C0037a {
        ...
        /* compiled from: MultiDex */
        private static class c implements C0038a {
            private final Constructor<?> a;
        ...
        /* compiled from: MultiDex */
        private static class d implements C0038a {
            private final Constructor<?> a;
        ...
        private C0037a() {
            ...
            L_0x001a:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.multidex.a.C0037a.<init>():void");
        }

        static void a(ClassLoader classLoader, List<? extends File> list) {
            Object obj = a.b(classLoader, "pathList").get(classLoader);
            Object[] a2 = new C0037a().a(list);
            try {
