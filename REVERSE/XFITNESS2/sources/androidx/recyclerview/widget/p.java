...
class p {
    ...
    public void b(java.util.List<androidx.recyclerview.widget.a.b> r9, int r10, androidx.recyclerview.widget.a.b r11, int r12, androidx.recyclerview.widget.a.b r13) {
        ...
        L_0x000d:
            ...
            int r5 = r5 - r4
            r13.d = r5
            androidx.recyclerview.widget.p$a r0 = r8.a
            int r1 = r11.b
        ...
        L_0x002b:
            ...
            int r5 = r5 + r6
            int r5 = r5 - r1
            androidx.recyclerview.widget.p$a r3 = r8.a
            int r1 = r1 + r4
        ...
        L_0x004c:
            r9.remove(r10)
            androidx.recyclerview.widget.p$a r11 = r8.a
            r11.a(r13)
        L_0x0054:
        ...
        L_0x005e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.p.b(java.util.List, int, androidx.recyclerview.widget.a$b, int, androidx.recyclerview.widget.a$b):void");
    }
    ...
    public void a(java.util.List<androidx.recyclerview.widget.a.b> r10, int r11, androidx.recyclerview.widget.a.b r12, int r13, androidx.recyclerview.widget.a.b r14) {
        ...
        L_0x002f:
            ...
            r10.remove(r13)
            androidx.recyclerview.widget.p$a r10 = r9.a
            r10.a(r14)
        L_0x0047:
            return
        L_0x0048:
        ...
        L_0x0053:
            ...
            int r4 = r4 + r7
            int r4 = r4 - r1
            androidx.recyclerview.widget.p$a r7 = r9.a
            int r1 = r1 + r3
        ...
        L_0x00eb:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.p.a(java.util.List, int, androidx.recyclerview.widget.a$b, int, androidx.recyclerview.widget.a$b):void");
    }
