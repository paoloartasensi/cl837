...
import com.chileaf.fitness.device.wear.cl800.g;
import com.chileaf.fitness.device.wear.cl800.h;
...
public final class CL800ViewModel extends BaseViewModel implements h {

    /* renamed from: f  reason: collision with root package name */
    private a<String> f1259f = new a<>();

    /* renamed from: g  reason: collision with root package name */
    private a<String> f1260g = new a<>();

    /* renamed from: h  reason: collision with root package name */
    private a<String> f1261h = new a<>();

    /* renamed from: i  reason: collision with root package name */
    private a<String> f1262i = new a<>();

    /* renamed from: j  reason: collision with root package name */
    private a<Integer> f1263j = new a<>();
    ...
    public CL800ViewModel(Application application) {
        super(application);
        i.b(application, "application");
        this.n = g.a(new CL800ViewModel$mManager$2(application));
        j();
        k().a(this);
        k().b(false);
    }
    ...
    private final void b(float f2) {
        this.f1262i.a(com.chileaf.fitness.config.a.a(R$string.distance_value, Float.valueOf(f2)));
    }
    ...
    private final CL800Manager k() {
        return (CL800Manager) this.n.getValue();
    }
    ...
    private final void b(int i2) {
        this.f1261h.a(com.chileaf.fitness.config.a.a(R$string.heart_rate_value, Integer.valueOf(i2)));
    }
    ...
    private final void a(int i2) {
        this.f1259f.a(com.chileaf.fitness.config.a.a(R$string.battery_level, Integer.valueOf(i2)));
    }

    private final void a(float f2) {
        this.f1260g.a(com.chileaf.fitness.config.a.a(R$string.calorie_value, Float.valueOf(f2)));
    }
    ...
    public void a(BluetoothDevice bluetoothDevice, int i2, int i3, int i4) {
        ...
        a(((float) i4) / 10.0f);
        b(((float) i3) / 100.0f);
        this.f1263j.a(Integer.valueOf(i2));
    }
