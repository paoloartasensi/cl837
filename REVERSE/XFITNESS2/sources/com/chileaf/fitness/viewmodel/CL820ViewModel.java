...
import com.chileaf.fitness.device.wear.cl820.g;
import com.chileaf.fitness.device.wear.cl820.h;
...
public final class CL820ViewModel extends BaseViewModel implements h {

    /* renamed from: f  reason: collision with root package name */
    private a<String> f1264f = new a<>();

    /* renamed from: g  reason: collision with root package name */
    private a<String> f1265g = new a<>();

    /* renamed from: h  reason: collision with root package name */
    private a<String> f1266h = new a<>();

    /* renamed from: i  reason: collision with root package name */
    private a<String> f1267i = new a<>();

    /* renamed from: j  reason: collision with root package name */
    private a<Integer> f1268j = new a<>();
    ...
    public CL820ViewModel(Application application) {
        super(application);
        i.b(application, "application");
        this.n = g.a(new CL820ViewModel$mManager$2(application));
        i();
        j().a(this);
        j().b(false);
    }
    ...
    private final void b(float f2) {
        this.f1267i.a(com.chileaf.fitness.config.a.a(R$string.distance_value, Float.valueOf(f2)));
    }
    ...
    private final CL820Manager j() {
        return (CL820Manager) this.n.getValue();
    }

    private final void k() {
        BluetoothDevice bluetoothDevice = this.m;
        if (bluetoothDevice != null) {
            n0 a = j().a(bluetoothDevice);
            a.a(true);
            a.a();
        }
    }
    ...
    public /* synthetic */ void a(BluetoothDevice bluetoothDevice, int i2, float f2) {
        g.a(this, bluetoothDevice, i2, f2);
    }
    ...
    private final void b(int i2) {
        this.f1266h.a(com.chileaf.fitness.config.a.a(R$string.heart_rate_value, Integer.valueOf(i2)));
    }
    ...
    private final void a(int i2) {
        this.f1264f.a(com.chileaf.fitness.config.a.a(R$string.battery_level, Integer.valueOf(i2)));
    }

    private final void a(float f2) {
        this.f1265g.a(com.chileaf.fitness.config.a.a(R$string.calorie_value, Float.valueOf(f2)));
    }
    ...
    public void a(BluetoothDevice bluetoothDevice, int i2, int i3, int i4) {
        ...
        a(((float) i4) / 10.0f);
        b(((float) i3) / 100.0f);
        this.f1268j.a(Integer.valueOf(i2));
    }
