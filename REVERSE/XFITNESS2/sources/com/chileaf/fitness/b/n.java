...
/* compiled from: ActivityCl830BindingImpl */
public class n extends m implements a.C0063a {
    ...
    public void a(CL830ViewModel cL830ViewModel) {
        this.E = cL830ViewModel;
        synchronized (this) {
            this.K |= 32;
        }
    ...
    public void a() {
        /*
            ...
            com.chileaf.fitness.viewmodel.CL830ViewModel r0 = r1.E
        ...
        L_0x0110:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.chileaf.fitness.b.n.a():void");
    }

    public final void a(int i2, CompoundButton compoundButton, boolean z) {
        CL830ViewModel cL830ViewModel = this.E;
        if (cL830ViewModel != null) {
            cL830ViewModel.a(z);
        }
    }
}
