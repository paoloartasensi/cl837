...
public final class e {
    ...
    public static final y c = y.a(new String[0]);
    public static final i0 d = i0.a((b0) null, a);
    private static final l e = l.a(ByteString.decodeHex("efbbbf"), ByteString.decodeHex("feff"), ByteString.decodeHex("fffe"), ByteString.decodeHex("0000ffff"), ByteString.decodeHex("ffff0000"));

    /* renamed from: f  reason: collision with root package name */
    private static final Charset f2023f = Charset.forName("UTF-32BE");

    /* renamed from: g  reason: collision with root package name */
    private static final Charset f2024g = Charset.forName("UTF-32LE");

    /* renamed from: h  reason: collision with root package name */
    public static final TimeZone f2025h = TimeZone.getTimeZone("GMT");

    /* renamed from: i  reason: collision with root package name */
    public static final Comparator<String> f2026i = a.e;

    /* renamed from: j  reason: collision with root package name */
    private static final Method f2027j;
    ...
    public static boolean b(r rVar, int i2, TimeUnit timeUnit) {
        ...
        long c2 = rVar.d().d() ? rVar.d().c() - nanoTime : Long.MAX_VALUE;
        rVar.d().a(Math.min(c2, timeUnit.toNanos((long) i2)) + nanoTime);
        try {
            c cVar = new c();
    ...
    public static y b(List<a> list) {
        y.a aVar = new y.a();
        for (a next : list) {
            c.a.a(aVar, next.a.utf8(), next.b.utf8());
        }
        return aVar.a();
    }
    ...
    public static List<a> a(y yVar) {
        ...
        for (int i2 = 0; i2 < yVar.b(); i2++) {
            arrayList.add(new a(yVar.a(i2), yVar.b(i2)));
        }
        return arrayList;
    }
    ...
    public static boolean a(z zVar, z zVar2) {
        return zVar.g().equals(zVar2.g()) && zVar.k() == zVar2.k() && zVar.n().equals(zVar2.n());
    }
}
